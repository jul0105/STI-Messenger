...
?>
    <div class="container">
        <div class="mb-3">
            ...
            <form action="<?= $edit ? "editUser.php?id=$id" : "newUserExec.php" ?>" method="post" class="needs-validation" novalidate>
                <div class="form-group row">
                    <label for="username" class="col-sm-2 col-form-label">Pseudo</label>
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="username" name="username" required <?= $edit ? "value=\"$username\"" : ''?>>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="status" name="status" <?= $edit ? ($status == STATUS_ACTIVE ? 'checked' : '') : 'checked' ?>>
